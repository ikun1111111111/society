        ...
        <div class="ab-note open" id="noteBox">
          ...
          <div class="ab-body">
            ...
            <div class="code-row account">
              <code>demo</code>
              <span>测试账号 · 口令 <b>xw2026</b> · 管理员，任何设备都能进</span>
    ...
    <section class="auth-card">
      ...
      <form class="apanel on" id="paneLogin" novalidate>
        ...
        <button class="aguest" type="button" id="demoBtn">
          <span class="gd">🚪</span>
          <span class="gt"><b>用测试账号一键进入</b><small>demo / xw2026 · 管理员 · 随时可进</small></span>
          <span class="ga">→</span>
        </button>
...
(function () {
  ...
  $('#demoBtn').addEventListener('click', function () { demoEnter(this); });
